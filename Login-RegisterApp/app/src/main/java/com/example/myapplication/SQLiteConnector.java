...
public class SQLiteConnector extends SQLiteOpenHelper {
    ...
    public List<User> getAllUser() {
        ...
        int userPasswordIndex = cursor.getColumnIndex(COLUMN_USER_PASSWORD);

        if (userIdIndex >= 0 && userNameIndex >= 0 && userEmailIndex >= 0 && userPasswordIndex >= 0) {
            User user = new User();
            user.setId(Integer.parseInt(cursor.getString(userIdIndex)));
